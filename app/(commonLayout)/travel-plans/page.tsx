...
import { getAllTravelPlans } from "@/services/travel-plans/getAllTravelPlans";
import { ITravelPlan } from "@/types/travelPlan.interface";


const TravelPlansPage = async ({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) => {
